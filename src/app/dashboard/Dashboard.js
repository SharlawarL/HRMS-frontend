  ...
  render () {
    return (
      <div>
        ...
        <div className="row">
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card bg-gradient-info card-img-holder text-white">
              <div className="card-body" style={{padding:'20px'}}>
                ...
                <h6 className="card-text">Present</h6>
          ...
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Absent</h6>
          ...
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card bg-gradient-success card-img-holder text-white">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Late</h6>
          ...
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card bg-gradient-warning card-img-holder text-white">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Forgot To</h6>
        ...
        <div className="row">
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card border border-info card-img-holder text-white">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text text-info">Former Employees</h6>
                <h3 className="mb-0 text-info">0</h3>
              </div>
            </div>
          </div>
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card border border-danger card-img-holder text-danger">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Pending Leave's</h6>
                <h3 className="mb-0">5</h3>
              </div>
            </div>
          </div>
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card  border border-success card-img-holder text-success">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Upcomming Project</h6>
                <h3 className="mb-0">10</h3>
              </div>
            </div>
          </div>
          <div className="col-md-3 stretch-card grid-margin">
            <div className="card  border border-warning card-img-holder text-warning">
              <div className="card-body" style={{padding:'20px'}}>
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
                <h6 className="card-text">Loan Application</h6>
                <h3 className="mb-0">4</h3>
              </div>
            </div>
          </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="clearfix mb-4">
                  <h4 className="card-title float-left">Running Projects</h4>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div id="traffic-chart-legend" className="rounded-legend legend-vertical legend-bottom-left pt-4">
                  <ul>
                    <li>
                      <span className="legend-dots bg-info"></span>Present
                      <span className="float-right">60%</span>
                    </li>
                    <li>
                      <span className="legend-dots bg-success"></span>Absent
                      <span className="float-right">30%</span>
                    </li>
                    <li>
                      <span className="legend-dots bg-danger"></span>Late
              ...
              <div className="card-body">
                ...
                <div className="d-flex mt-5 align-items-start">
                  ...
                  <div className="mb-0 flex-grow">
                    <h5 className="mr-2 mb-2">Office Website - Authentication Module.</h5>
